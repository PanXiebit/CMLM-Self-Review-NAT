...
rm -r wmt16
cd ../..
python preprocess.py --source-lang en --target-lang ro --output-format raw --trainpref data/wmt16.en-ro/train --validpref data/wmt16.en-ro/valid --testpref data/wmt16.en-ro/test --destdir data-raw/wmt16.en-ro --joined-dictionary --workers 8 --nwordssrc 40000 --nwordstgt 40000
python preprocess.py --source-lang ro --target-lang en --output-format raw --trainpref data/wmt16.en-ro/train --validpref data/wmt16.en-ro/valid --testpref data/wmt16.en-ro/test --destdir data-raw/wmt16.ro-en --joined-dictionary --workers 8 --nwordssrc 40000 --nwordstgt 40000
